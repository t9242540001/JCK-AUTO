...
export function generateMetadata(): Metadata {
  return {
    title: "Ноускаты из Китая — комплект передней части авто | JCK AUTO",
    description:
      "Ноускат — комплект деталей передней части: бампер, оптика, радиатор, телевизор, датчики, камера. В наличии и под заказ ~30 дней. От 199 000 ₽.",
    openGraph: {
      title: "Ноускаты из Китая — комплект передней части авто | JCK AUTO",
      description:
        "Ноускат — комплект деталей передней части: бампер, оптика, радиатор, телевизор, датчики, камера. В наличии и под заказ ~30 дней. От 199 000 ₽.",
      ...
      <section className="bg-surface pb-10 pt-28 sm:pb-16">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-center text-base text-text-muted sm:text-lg">
            Продажа комплектов деталей передней части авто — бампер, оптика, радиатор,
            телевизор, датчики, камера. В наличии и под заказ ~30 дней.
            Лучшая цена на российском рынке.
          </p>
        </div>
      </section>
