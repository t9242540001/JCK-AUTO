...
export const metadata: Metadata = {
  ...
  description: 'Загрузите фото аукционного листа — AI переведёт на русский и расшифрует оценки состояния автомобиля.',
  openGraph: { url: 'https://jckauto.ru/tools/auction-sheet' },
