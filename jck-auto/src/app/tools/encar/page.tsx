...
const faqItems = [
  ...
  { question: "Насколько точен расчёт стоимости?", answer: "Курс ЦБР обновляется каждый час. Ставки пошлин и утильсбора актуальны на 2026 год. Точность ±5-10%, для точного расчёта свяжитесь с менеджером." },
];
