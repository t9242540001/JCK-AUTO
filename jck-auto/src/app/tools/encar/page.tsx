...
export const metadata: Metadata = {
  ...
  description: 'Вставьте ссылку с Encar.com — получите перевод характеристик на русский и расчёт стоимости доставки авто из Кореи в Россию.',
  openGraph: { url: 'https://jckauto.ru/tools/encar' },
