...
export const metadata: Metadata = {
  title: {
    absolute:
      "О компании JCK AUTO — команда экспертов по импорту авто из Азии",
  },
  description:
  ...
  keywords:
    "JCK AUTO, импорт авто из Азии, компания по ввозу автомобилей, авто из Китая компания, гарантия ВСК автомобиль",
};
