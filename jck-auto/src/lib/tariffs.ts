/**
 * @file tariffs.ts
 * @description Тарифный справочник: все ставки, коэффициенты и пороги для расчёта таможенных платежей.
 *              Данные соответствуют нормативке РФ на дату lastUpdated.
 * @rule НЕ менять числовые значения без явного согласования — они сверены с нормативными документами
 * @rule При изменении ставок обновить lastUpdated и validUntil
 * @sources Решение ЕАЭС 2017 (ЕТС), ПП РФ №1713 от 2025 (утильсбор), НК РФ ст.193 (акциз), ПП РФ №863 (таможенный сбор)
...
export const TARIFF_META = {
  ...
  sources: [
    ...
    'ПП РФ №1713 от 2025 — утилизационный сбор с 01.12.2025',
