...
> Network architecture (nginx config, Cloudflare Worker tg-proxy, provider
> restrictions, Yandex Metrika MCP install) lives in `networking.md`. This
> file covers server runtime — what runs where, deploy pipeline, runtime
> constraints.
