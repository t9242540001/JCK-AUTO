<!--
  @file:        knowledge/decisions-archive-1.md
  @project:     JCK AUTO
  @description: Archive 1 of decisions.md — 81 ADRs spanning 2026-01..2026-04-28
  @updated:     2026-05-02
  @version:     1.0
  @lines:       ~4485
  @note:        Read-only archive. NOT read at session start by default. Open
                only when investigating historical context — when a current ADR
                in active decisions.md references an older entry, or when
                debugging requires understanding past trade-offs. Created by
                KC-1 (knowledge-cleanup series, 2026-05-02) to bring active
                decisions.md back within readable size. Cutoff: ADRs dated
                2026-04-29 and later remain active; this archive contains
                everything older.
-->

# Architectural Decisions — Archive 1

> ADRs from project inception (2026-01) through 2026-04-28. For active decisions
> from 2026-04-29 onward, see `decisions.md`. Entries within this file are in
> the same top-down chronological order as the original.
