...
| [bugs.md](bugs.md) | Open bugs tracker — С-1 closed, С-5 user-impact closed (moved to Verify), С-6 closed (cross-tab session leak fixed), С-4 closed (/api/lead hardened), С-3 closed (on-primary CTA variant), Б-1 closed (Cloudflare Smart Placement), Б-2 and Б-3 closed (side-effect of Smart Placement), С-2 open, Б-4–Б-8 open. Middleware-manifest restart loop (Б-7), Capture workflow verification (Б-8) pending | 2026-04-20 |
