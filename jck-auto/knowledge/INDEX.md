...
| [decisions.md](decisions.md) | Architectural Decision Records (ADR log) — active section. Contains 16 most recent ADRs (2026-04-29 onward) + CRIT-1 + SALES-CRIT-2 (2026-05-04). Older 81 entries → [decisions-archive-1.md](decisions-archive-1.md). Auto-archive trigger at 1000 lines. | 2026-05-04 |
