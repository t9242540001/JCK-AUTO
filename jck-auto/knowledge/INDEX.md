...
| [bugs.md](bugs.md) | Open bugs tracker — С-1 closed, С-5 user-impact closed (moved to Verify), С-6 closed (cross-tab session leak fixed), С-2–С-4 open, Б-1–Б-8 open. Middleware-manifest restart loop (Б-7), Capture workflow verification (Б-8) pending | 2026-04-19 |
