<!--
  @file:        knowledge/roadmap-archive-2.md
  @project:     JCK AUTO
  @description: Archive 2 of roadmap.md — Recent Activity entries and Done bullets from 2026-04-28 and earlier
  @updated:     2026-05-02
  @version:     1.0
  @lines:       ~470
  @note:        Read-only archive. NOT read at session start by default. Open
                only when investigating historical session context — when
                trying to understand what was done in a specific past sprint
                or what predecessors led to a current ADR. Created by KC-2
                (knowledge-cleanup series, 2026-05-02) to bring active
                roadmap.md back within readable size. Cutoff: entries dated
                2026-04-29 and later remain in active roadmap.md (plus
                whitelisted 2026-04-26 v2.0 migration entry); this archive
                contains everything older.

                roadmap-archive-1.md (2026-04-26) contains undated
                historical Done one-liners. roadmap-archive-2.md (this
                file, 2026-05-02) contains dated entries from 2026-04-28
                and earlier — Recent Activity blocks plus Done bullets.
-->

# Roadmap — Archive 2

> Recent Activity entries and Done bullets from 2026-04-28 and earlier.
> For active project state, see `roadmap.md`. For undated historical
> Done entries, see `roadmap-archive-1.md`. Entries within this file are
> in the same top-down chronological order as the original.

## Archived Recent Activity entries
